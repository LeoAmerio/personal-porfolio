...
export function ExperienceCard({ experience, isLast }: ExperienceCardProps) {
  ...
  return (
    ...
    <div className="relative">
      {/* Timeline connector */}
      {!isLast && <div className="absolute left-8 top-16 bottom-0 w-0.5 bg-blue-500/30" />}

      <div className="flex gap-8">
        {/* Company logo */}
        <div className="relative z-10">
          <div className="w-16 h-16 bg-gray-800 rounded-full overflow-hidden flex items-center justify-center border-2 border-blue-500/30 shadow-lg shadow-blue-500/10">
            <Image
              src={experience.logo || "/placeholder.svg"}
              alt={experience.company}
              width={50}
        ...
        <div className="flex-1">
          <div className="flex flex-col md:flex-row md:items-center justify-between mb-4">
            <h2 className="text-2xl font-semibold text-blue-400">{experience.company}</h2>
            <div className="text-gray-400 bg-gray-800 px-4 py-1 rounded-full text-sm mt-2 md:mt-0">
              {experience.startDate} - {experience.endDate}
            </div>
          </div>

          <h3 className="text-xl text-white mb-4">{experience.role}</h3>
          ...
          <div className="bg-gray-800 rounded-xl p-6 border border-gray-700 shadow-lg">
            <h4 className="text-lg font-medium mb-4 text-blue-400">{t("projects_responsibilities")}</h4>
